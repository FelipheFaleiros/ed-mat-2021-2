//Função tradicional com parâmetro e 1 linha no corpo, com return
function quadrado(x){
    return x * x
}
// ARROW FUNCTION: forma "abreviada" de escrever função em JS
...
// 4) Entre o parâmetro e o corpo da função, temos o sinal "=>"(arrow, fecha)
// 5) Desaparecem as chaves que delimitam o corpo da função 
// 6) Desaparecem a palavra-chave "return"
...
// Retornam os parênteses e torno dos parâmentos
