...
console.log(`Área de um retangulo de 15x12: ${calcArea(forma1)}`)
...
/*
    ...
    um cálculo válido, precisa ter algumas caracteristicas específicas:
    1) Precisa ter a propriedade "base", "altura" e "tipo"
    2) As propriedades "base" e "altura" devem conter valores numéricos maior que zero
    3) A propriedade "tipo" deve aceitar apenas valores 'R', 'T' ou 'E'

    Problema: a linguagem JavaScript permite a livre criação de objetos, 
    sem imposição de regras ou caracteristicas obrigatórias.

    Solução: declarar uma CLASSE que contenha as regras de existência 
    de um objeto e criar os objetos necessários a partir da classe.
    ...
    Com essa forma, podem se feito: pudim, bolo de fubá, cuscuz paulista, etc.
